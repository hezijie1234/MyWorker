...
/**
 * 继承了Activity，实现Android6.0的运行时权限检测  闪屏界面继承
 */
public class CheckPermissionsActivity extends FragmentActivity
	...
	private List<String> findDeniedPermissions(String[] permissions) {
		...
		for (String perm : permissions) {
			if (ContextCompat.checkSelfPermission(this, perm) != PackageManager.PERMISSION_GRANTED || ActivityCompat.shouldShowRequestPermissionRationale(
							this, perm)) {
